...
const SavedBanksComponent = ({ banks, loading, removeValue }) => {
            ...
            <table>
                ...
                {banks &&  banks.map(bank => (
                    <tr>
                        ...
                        <td style={{ textAlign:'center'}}><button onClick={() => removeValue(bank.ifsc)}>remove</button></td>
                    </tr>
                )
                )}
...
export default SavedBanksComponent;